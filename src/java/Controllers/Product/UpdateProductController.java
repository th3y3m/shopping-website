...
public class UpdateProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (productId != null && productName != null && supplierId != null && categoryId != null && quantityPerUnit != null && unitPrice != null && productImage != null) {
                product = new Product(productId, productName, supplierId, categoryId, Integer.parseInt(quantityPerUnit), Double.parseDouble(unitPrice), productImage);
                ProductDAO productDao = new ProductDAO();
                if (productDao.updateProduct(product)) {
                    message = "The product ID " + productId + " has been updated successfully";
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
